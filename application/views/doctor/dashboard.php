            ...
            <div class="action-nav-normal">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo ('Prescripción');?></span>
  ...
  $(document).ready(function() {
    ...
    $("#schedule_calendar").fullCalendar({
            ...
            events: [
                    ...
                    $citas	=	$this->db->get_where('cita' , array('doctor_id' => $this->session->userdata('doctor_id')))->result_array();
...

					{
						...
						title: "<?php echo ('Appointment').' : '.$this->crud_model->get_type_name_by_id('paciente' ,$row['paciente_id'], 'name' );?>",
