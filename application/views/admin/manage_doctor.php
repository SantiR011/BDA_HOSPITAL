        ...
        <ul class="nav nav-tabs nav-tabs-left">
            ...
            <li class="active">
                <a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
                    <?php echo ('Editar Doctor');?>
                </a></li>
            <?php endif;?>
            <li class="<?php if(!isset($edit_profile))echo 'active';?>">
                <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
                    <?php echo ('Lista de Doctores');?>
                </a></li>
            <li>
                <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo ('Agregar Doctor');?>
                </a></li>
        </ul>
        <!------CONTROL TABS END-------> 
    </div>
        ...
        <div class="tab-content">
                ...
                <div class="box-content">
                    ...
                    <div class="padded">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="email" class="validate[required, custom[email]]" name="email" value="<?php echo $row['email'];?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="validate[required, custom[phone]]" name="phone" value="<?php echo $row['phone'];?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"><?php echo ('Departamento');?></label>
                            <div class="controls">
                                <select name="especialidad_id" class="uniform" style="width:100%;">
                                    <?php 
                                    $especialidads = $this->db->get('especialidad')->result_array();
                                    foreach($especialidads as $row2):
                                    ?>
                                    <option value="<?php echo $row2['especialidad_id'];?>"
                                        <?php if($row['especialidad_id'] == $row2['especialidad_id'])echo 'selected';?>>
                                        <?php echo $row2['name'];?>
                                    </option>
                                    <?php endforeach;?>
                                </select>
                        ...
                        <div class="control-group">
                            <label class="control-label"><?php echo ('Perfil');?></label>
                            <div class="controls">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary"><?php echo ('Editar Doctor');?></button>
                    </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                    <thead>
                        <tr>
                            <th><div>#</div></th>
                            <th><div><?php echo ('Nombre del Doctor');?></div></th>
                            <th><div><?php echo ('Departamento');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->crud_model->get_type_name_by_id('especialidad',$row['especialidad_id']);?></td>
                            <td align="center">
                                ...
                                <a href="<?php echo base_url();?>index.php?admin/manage_doctor/delete/<?php echo $row['doctor_id'];?>" onclick="return confirm('¿eliminar?')"
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="especialidad_id" class="uniform" style="width:100%;">
                                    ...
                                    ?>
                                    <option value="<?php echo $row['especialidad_id'];?>"><?php echo $row['name'];?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-success"><?php echo ('Agregar Doctor');?></button>
                    </div>
                    <?php echo form_close();?>                
                </div>                
            </div>
