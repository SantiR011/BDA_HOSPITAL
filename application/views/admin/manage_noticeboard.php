		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_anuncios/edit/do_update/'.$row['notice_id'] , array('class' => 'form-horizontal validatable'));?>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_anuncios/edit/<?php echo $row['notice_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_anuncios/delete/<?php echo $row['notice_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_anuncios/create/' , array('class' => 'form-horizontal validatable'));?>
