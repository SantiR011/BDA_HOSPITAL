                ...
                <div class="box-content padded">
                    ...
                    foreach ($edit_profile as $row):
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" class="validate[required,minSize[6]]" name="password" value="" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" class="validate[required,minSize[6]]" name="new_password" value="" />
                            </div>
                        </div>
