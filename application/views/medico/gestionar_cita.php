                ...
                <div class="tab-pane box active" id="edit" style="padding: 5px">
                    <div class="box-content">
                        <?php foreach($edit_profile as $row): ?>
                            <?php echo form_open('medico/gestionar_cita/edit/do_update/'.$row['cita_id'], array('class' => 'form-horizontal validatable')); ?>
                            <div class="padded">
                    ...
                    <input type="hidden" name="fecha_hora" id="fecha_hora_oculto" />
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<?php echo site_url('admin/gestionar_cita'); ?>" class="btn btn-default"><?php echo ('Cancelar'); ?></a>
                            </div>
                            <?php echo form_close(); ?>
                        <?php endforeach; ?>
                    </div>
