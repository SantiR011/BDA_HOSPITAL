            ...
            <div class="tab-pane box active" id="perfil" style="padding: 5px">
                <div class="box-content padded">
                    <?php foreach ($edit_profile as $row): ?>
                        <?php echo form_open('medico/gestionar_perfil/update_profile_info/', array('class' => 'form-horizontal validatable')); ?>
            ...
            <div class="tab-pane box active" id="password" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" name="new_password" class="validate[required,minSize[6]]" required />
                        </div>
                    </div>
