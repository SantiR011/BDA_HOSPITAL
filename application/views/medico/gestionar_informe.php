		...
		<div class="tab-content">            
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $this->crud_model->get_type_name_by_id('paciente',$row['numero_id'],'name');?></td>

							<td><?php echo $this->crud_model->get_type_name_by_id('medico',$row['numero_id'],'name');?></td>

							<td align="center">

                            	<a href="<?php echo base_url();?>index.php?medico/manage_report/delete/<?php echo $row['report_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('medico/manage_report/create/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select class="chzn-select" name="numero_id">
										...
										?>
                                        	...
                                        	<option value="<?php echo $row2['numero_id'];?>" ><?php echo $row2['name'];?></option>
                                ...
                                <div class="controls">
                                    ...
                                    <select class="chzn-select" name="numero_id">
										...
										?>
                                        	...
                                        	<option value="<?php echo $row['numero_id'];?>"><?php echo $row['name'];?></option>
