...

{
	...
	/***Default function, redirects to login page if no medico logged in yet***/
...

	{
		...
		$page_data['page_title'] = ('Cuadro de mandos de enfermería');
...

	{
		...
		if ($param1 == 'create') {
			...
			redirect(base_url() . 'index.php?medico/manage_paciente', 'refresh');
		...
		if ($param1 == 'delete') {
			...
			redirect(base_url() . 'index.php?medico/manage_program', 'refresh');
...

	{
		...
		if ($param1 == 'create') {
			...
			redirect(base_url() . 'index.php?medico/manage_bed', 'refresh');
		...
		$page_data['page_title'] = ('Gestionar cama');
...

	{
		...
		if ($param1 == 'edit' && $param2 == 'do_update') {
			...
			redirect(base_url() . 'index.php?medico/manage_blood_bank', 'refresh');
		...
		$page_data['page_title'] = ('Gestionar el banco de sangre');
...

	{
		...
		if ($param1 == 'create') {
			...
			redirect(base_url() . 'index.php?medico/manage_blood_donor', 'refresh');
		...
		$page_data['page_title']   = ('Gestionar la donación de sangre');
...

	{
		...
		if ($param1 == 'update_profile_info') {
			...
			redirect(base_url() . 'index.php?medico/manage_profile/', 'refresh');
